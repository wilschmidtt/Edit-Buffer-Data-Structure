...
* Goals: Gain experience using Unix shell, gain experience writing and debugging a program with VIM, and gain experinece with test driven development through using a series of Google Tests to ensure that the program works correctly.
